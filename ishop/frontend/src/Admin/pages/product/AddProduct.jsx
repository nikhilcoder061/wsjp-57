...
export default function AddProduct() {
  ...
  const { toastNotify, API_BASE_URL, fetchCategories, fetchColor, allCategory, allColor, PRODUCT_URL } = useContext(MainContext);
  ...
  return (
    ...
    <div className="w-full mx-auto p-8 border rounded-lg">
      ...
      <form className="grid grid-cols-1 md:grid-cols-3 gap-4" onSubmit={addProduct}>
        {/* Product Name */}
        <div>
          <label
            htmlFor="name"
